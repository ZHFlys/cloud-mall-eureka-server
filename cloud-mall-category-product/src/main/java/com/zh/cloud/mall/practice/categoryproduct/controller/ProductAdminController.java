package com.zh.cloud.mall.practice.categoryproduct.controller;
...
import com.zh.cloud.mall.practice.categoryproduct.model.request.UpdateProductReq;
    ...
    public ApiRestResponse upload(HttpServletRequest httpServletRequest,
        ...
        if (!fileDirectory.exists()) {
            if (!fileDirectory.mkdir()) {
                throw new ZhMallException(ZhMallExceptionEnum.MKDIR_FAILED);
            }
        }
        try {
        ...
        try {
            ...
            return ApiRestResponse.error(ZhMallExceptionEnum.UPLOAD_FAILED);
        }
    }
